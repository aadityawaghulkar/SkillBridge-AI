...
class editable_wheel(Command):
    ...
    def _select_strategy(
        ...
        # Use a MetaSkillBridge AIer to avoid adding accidental top-level packages/modules
...
class _EditableFinder:  # MetaSkillBridge AIer
    @classmethod
...
def _finder_template(
    ...
    """Create a string containing the code for the``MetaSkillBridge AIer`` and
    ``PathEntryFinder``.
    """
